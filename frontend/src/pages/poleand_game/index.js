    ...
    function (moduleArg = {}) {
      ...
      var FS = {
        ...
        createDefaultDevices() {
          ...
          FS.mkdev("/src/null", FS.makedev(1, 3));
          TTY.register(FS.makedev(5, 0), TTY.default_tty_ops);
          TTY.register(FS.makedev(6, 0), TTY.default_tty1_ops);
          FS.mkdev("/src/tty", FS.makedev(5, 0));
          FS.mkdev("/src/tty1", FS.makedev(6, 0));
          ...
          FS.createDevice("/src", "random", randomByte);
          FS.createDevice("/src", "urandom", randomByte);
          FS.mkdir("/src/shm");
          FS.mkdir("/src/shm/tmp")
        },
        ...
        createStandardStreams() {
          if (Module["stdin"]) {
            FS.createDevice("/src", "stdin", Module["stdin"])
          } else {
            FS.symlink("/src/tty", "/src/stdin")
          }
          if (Module["stdout"]) {
            FS.createDevice("/src", "stdout", null, Module["stdout"])
          } else {
            FS.symlink("/src/tty", "/src/stdout")
          }
          if (Module["stderr"]) {
            FS.createDevice("/src", "stderr", null, Module["stderr"])
          } else {
            FS.symlink("/src/tty1", "/src/stderr")
          }
      ...
      var GodotFS = {
        ENOENT: 44, _idbfs: false, _syncing: false, _mount_points: [], is_persistent: function () {
      ...
      var GodotOS = {
        ...
        }, _async_cbs: [], _fs_sync_promise: null, atexit: function (p_promise_cb) {
      ...
      function _godot_audio_sample_register_stream(streamObjectIdStrPtr, framesPtr, framesTotal, loopModeStrPtr, loopBegin, loopEnd) {
        ...
        GodotAudio.Sample.create({id: streamObjectId, audioBuffer: audioBuffer}, {
          loopBegin: loopBegin,
          loopEnd: loopEnd,
          loopMode: loopMode,
      ...
      var GodotAudioWorklet = {
        promise: null, worklet: null, ring_buffer: null, create: function (channels) {
      ...
      var GodotDisplayCursor = {
        shape: "default", visible: true, cursors: {}, set_style: function (style) {
      ...
      var GodotEventListeners = {
        handlers: [], has: function (target, event, method, capture) {
      ...
      var GodotDisplayScreen = {
        desired_size: [0, 0], hidpi: true, getPixelRatio: function () {
      ...
      var GodotDisplayVK = {
        textinput: null, textarea: null, available: function () {
      ...
      var IDHandler = {
        _last_id: 0, _references: {}, get: function (p_id) {
      ...
      var GodotInputDragDrop = {
        promises: [], pending_files: [], add_entry: function (entry) {
      ...
      var GodotIME = {
        ime: null, active: false, getModifiers: function (evt) {
      ...
      var GodotPWA = {
        hasUpdate: false, updateState: function (cb, reg) {
          if (!reg) {
            return
          }
          if (!reg.active) {
      ...
      function _godot_js_rtc_pc_remote_description_set(p_id, p_type, p_sdp, p_obj, p_session_created, p_on_error) {
        ...
        ref.setRemoteDescription({sdp: sdp, type: type}).then(function () {
          if (type !== "offer") {
            return Promise.resolve()
          }
      ...
      var GodotJSWrapper = {
        proxies: null, cb_ret: null, MyProxy: function (val) {
